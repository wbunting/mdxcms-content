...
- ⬇ **Simple**: MDX all the way down! You can edit documents with a WISYWIG mdx editor or just raw MDX.
- 🔓**No lock in**: Choose a Github Pages or hosted backend. Always export all your documents. They are just markdown!
- 💴**Free**: if you choose to use Github Pages as your backend! For now hosted is free as well, but we may change that depending on popularity.
- 🎩 **Flexible**: take it how you like it. You can just use Github Pages and the npm module to get the content onto your page. You can also use the built in editors / integrations to get a bit more speed / ease of use. 
...
- 📃 **Documentation**: Use custom MDX components to do things like render code snippets or live examples.
